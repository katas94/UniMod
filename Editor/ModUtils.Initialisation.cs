...
namespace ModmanEditor
{
    public static partial class ModUtils
    {
        ...
        public const string InitModSetupMenuItem = MENU_ITEM + "Init or check mod setup";
        ...
        // private static string MainAssemblyName => string.IsNullOrEmpty(ModConfig.Instance?.Id) ? "Main" : ModConfig.Instance.Id;

        [MenuItem(InitModSetupMenuItem, false, 0)]
        ...
        public static bool VerifyModSetup ()
        {
            ...
            // bool isSetupValid = ModConfig.Instance != null && AddressableAssetSettingsDefaultObject.SettingsExists;
            //
        ...
        public static void InitialiseOrCheckModSetup ()
        {
            ...
            // {
            //     var definition = ScriptableObject.CreateInstance<ModConfig>();
            //     definition.Id = "com.company.modname";
            //     definition.ModVersion = "1.0.0";
